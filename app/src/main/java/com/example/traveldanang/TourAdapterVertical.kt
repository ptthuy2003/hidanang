...
class TourAdapterVertical(
    private val context: Context,
    private val tourArrayList: ArrayList<Tour>
) : RecyclerView.Adapter<TourAdapterVertical.ItemViewHolder>() {
    class ItemViewHolder(private val view: View) : RecyclerView.ViewHolder(view)
    {
        var id = ""
        val tvName = view.findViewById<TextView>(R.id.text_name)
        val tvLocation = view.findViewById<TextView>(R.id.text_location)
        val tvPrice = view.findViewById<TextView>(R.id.text_price)
        val image = view.findViewById<ImageView>(R.id.imageView)
        val btn_like = view.findViewById<ToggleButton>(R.id.btn_like)
        val db = FirebaseFirestore.getInstance()
        val auth = FirebaseAuth.getInstance()

        val layout = view.findViewById<CardView>(R.id.cardTourVertical)
        init {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ItemViewHolder {
        val adapterLayout = LayoutInflater.from(parent.context).inflate(R.layout.tour_vertical_liked, parent, false)
